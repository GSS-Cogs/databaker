Feature: Produce a pandas dataframe containing all data values in the format of a single observation per row.
    ...
    Scenario Outline: Complete the databaking process from a file path - produce a correct dataframe.
